...
sensitivty_dat <- sensitivty_dat %>% mutate(temp = temp_feb)

# move temp_feb samples column 
...
# move precip_jan samples column 
...
functions; you can have the profit function "call"/use the almond yield
function; or create a wrapper function that calls them in sequence
(first the almond yield and then the profit function) 
