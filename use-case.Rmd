...
sensitivty_dat_param_2 <- as.data.frame(do.call(rbind, 
                                        lapply(almond_yield_param_1, as.vector)))

# set column names as year
colnames(sensitivty_dat_param_2) <- as.character(dat$year)

# start data wrangling
sensitivty_dat_param_2 <- sensitivty_dat_param_2 %>% 
...
ggplot(sensitivty_dat_param_2, aes(year, yield_anom, group = year)) + 
  geom_boxplot() + 
